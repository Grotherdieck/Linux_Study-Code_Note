...
![](https://gitee.com/router123456/drawing-bed/raw/master/img/20220125115002.png)

&emsp;&emsp;``yum``三板斧:``yum list、yum install、yum remove``

&emsp;&emsp;yum中使用``sudo list``列出所有可以安装的软件。

![](https://gitee.com/router123456/drawing-bed/raw/master/img/20220125115151.png)

&emsp;&emsp;如果要关键字搜索，可以``sudo yum list | grep 'sl'``

&emsp;&emsp;考虑到架构，可以这样关键字搜索``sudo yum list | grep 'sl.x86_64'``

![](https://gitee.com/router123456/drawing-bed/raw/master/img/20220125115429.png)
...
![](https://gitee.com/router123456/drawing-bed/raw/master/img/20220125115731.png)

&emsp;&emsp;``sudo yum remove sl.x86_64``卸载这个程序，加上``-y``就不会有什么是否要卸载的提示。

![](https://gitee.com/router123456/drawing-bed/raw/master/img/20220125115906.png)

&emsp;&emsp;卸了以后又能重新安装了：

![](https://gitee.com/router123456/drawing-bed/raw/master/img/20220125115948.png)

![](https://gitee.com/router123456/drawing-bed/raw/master/img/20220125120056.png)

![](https://gitee.com/router123456/drawing-bed/raw/master/img/20220125120157.png)

&emsp;&emsp;可以搜索一下Linux Centos7必装的软件/好玩的命令。

&emsp;&emsp;``yum``源：

![](https://gitee.com/router123456/drawing-bed/raw/master/img/20220125120837.png)

![](https://gitee.com/router123456/drawing-bed/raw/master/img/20220125121019.png)

&emsp;&emsp;这个``CentOS-Base.repo``是官方的，稳定的，是一些比较老的稳定的文件，非官方比较新的软件，放在扩展源里：``sudo yum install -y epel-release``.

![](https://gitee.com/router123456/drawing-bed/raw/master/img/20220125121421.png)
...
![](https://gitee.com/router123456/drawing-bed/raw/master/img/20220125123346.png)

&emsp;&emsp;它还可以使用指令上传下载文件。

&emsp;&emsp;``rz``：本地``windows``文件上传``Linux``服务器

![](https://gitee.com/router123456/drawing-bed/raw/master/img/20220125123708.png)

&emsp;&emsp;``sz 文件名``：服务器文件上传``windows``

![](https://gitee.com/router123456/drawing-bed/raw/master/img/20220125123558.png)
...
![](https://gitee.com/router123456/drawing-bed/raw/master/img/20220125132957.png)
...
![](https://gitee.com/router123456/drawing-bed/raw/master/img/20220125150712.png)
...
![](https://gitee.com/router123456/drawing-bed/raw/master/img/20220125152334.png)
...
![](https://gitee.com/router123456/drawing-bed/raw/master/img/20220125151322.png)
...
![](https://gitee.com/router123456/drawing-bed/raw/master/img/20220125151737.png)

&emsp;&emsp;然后输入端口号5903，点击确定。

![](https://gitee.com/router123456/drawing-bed/raw/master/img/20220125151810.png)
...
![](https://gitee.com/router123456/drawing-bed/raw/master/img/20220125152016.png)

&emsp;&emsp;然后输入之前的密码就进来了：

![](https://gitee.com/router123456/drawing-bed/raw/master/img/20220125152602.png)
...
<img src="https://gitee.com/router123456/drawing-bed/raw/master/img/20220218140618.png" style="zoom:67%;" />
...
<img src="https://gitee.com/router123456/drawing-bed/raw/master/img/20220218112229.png" style="zoom: 50%;" />
...
![](https://gitee.com/router123456/drawing-bed/raw/master/img/20220218112958.png)
...
![](https://gitee.com/router123456/drawing-bed/raw/master/img/20220218114131.png)
...
<img src="https://gitee.com/router123456/drawing-bed/raw/master/img/20220218120040.png" style="zoom:67%;" />
...
![](https://gitee.com/router123456/drawing-bed/raw/master/img/20220218120346.png)
...
<img src="https://gitee.com/router123456/drawing-bed/raw/master/img/20220218130107.png" style="zoom:67%;" />
...
<img src="https://gitee.com/router123456/drawing-bed/raw/master/img/20220218124006.png" style="zoom:67%;" />

### 2 多个文件分屏

&emsp;&emsp;进入底行模式后输入``vs 文件名``即可。

![](https://gitee.com/router123456/drawing-bed/raw/master/img/20220218124415.png)

&emsp;&emsp;当然还可以继续分屏。

![](https://gitee.com/router123456/drawing-bed/raw/master/img/20220218124618.png)
...
![](https://gitee.com/router123456/drawing-bed/raw/master/img/20220218125245.png)
...
![](https://gitee.com/router123456/drawing-bed/raw/master/img/20220218132020.png)

&emsp;自己普通用户vim的基础配置都会写在``.vimrc``文件中，往其中增加命令就可以配置vim，如增加行号``set nu``.

![](https://gitee.com/router123456/drawing-bed/raw/master/img/20220218132235.png)

&emsp;&emsp;打开后默认带了行号：

![](https://gitee.com/router123456/drawing-bed/raw/master/img/20220218132329.png)
...
![](https://gitee.com/router123456/drawing-bed/raw/master/img/20220218134035.png)
...
![](https://gitee.com/router123456/drawing-bed/raw/master/img/20220218140224.png)

## V vim的奇淫巧技

1 gg=G 瞬间全部正确缩进格式。 

<img src="https://gitee.com/router123456/drawing-bed/raw/master/img/20220308231316.png" style="zoom:80%;" />

<img src="https://gitee.com/router123456/drawing-bed/raw/master/img/20220308231339.png" style="zoom:80%;" />

2 vim批量注释

``ctrl + v``进入某模式，然后利用``hjkl``作为上下左右选中需要加``//``的区域，然后``I``输入``//``，然后ESC退出即可。

<img src="https://gitee.com/router123456/drawing-bed/raw/master/img/20220308231527.png" style="zoom:80%;" />

批量取消注释：``ctrl + v``进入某模式，然后选中要删除区域，然后d即可。

<img src="https://gitee.com/router123456/drawing-bed/raw/master/img/20220308231656.png" style="zoom:80%;" />

<img src="https://gitee.com/router123456/drawing-bed/raw/master/img/20220308231716.png" style="zoom:80%;" />

# 4 Linux上的编译器—gcc/g++

<img src="https://gitee.com/router123456/drawing-bed/raw/master/img/20220222190153.png" style="zoom:80%;" />
...
<img src="https://gitee.com/router123456/drawing-bed/raw/master/img/20220222223401.png" style="zoom:80%;" />

&emsp;&emsp;加上``-o 文件名.i``就可以把预处理后的临时文件放到``文件名.i``中，预处理后的文件名字后缀一般是``.i``

![](https://gitee.com/router123456/drawing-bed/raw/master/img/20220222190613.png)

&emsp;&emsp;发现头文件展开了，并且完成了宏替换

<img src="https://gitee.com/router123456/drawing-bed/raw/master/img/20220222190756.png" style="zoom:80%;" />
...
<img src="https://gitee.com/router123456/drawing-bed/raw/master/img/20220222191144.png" style="zoom:80%;" />

&emsp;&emsp;汇编语言计算机也不能直接执行，需要汇编器从汇编语言搞成二进制。

## III -c

![](https://gitee.com/router123456/drawing-bed/raw/master/img/20220222191410.png)

&emsp;&emsp;``-c``的含义是开始翻译工作，完成汇编过程后停下，汇编语言会变成二进制。

![](https://gitee.com/router123456/drawing-bed/raw/master/img/20220222191500.png)

&emsp;&emsp;汇编形成的机器码文件不能直接执行，学术名称是**可重定向二进制文件**，等价于VS中的``.obj``文件.

&emsp;&emsp;下面的测试表明就算加上了可执行权限也无法执行。

![](https://gitee.com/router123456/drawing-bed/raw/master/img/20220222191720.png)
...
<img src="https://gitee.com/router123456/drawing-bed/raw/master/img/20220222192207.png" style="zoom:80%;" />
...
![](https://gitee.com/router123456/drawing-bed/raw/master/img/20220222193004.png)
...
![](https://gitee.com/router123456/drawing-bed/raw/master/img/20220222194246.png)

&emsp;&emsp;``libc.so.6``去掉``lib``和后缀，此库的名字就是``c``,即C标准库。

![](https://gitee.com/router123456/drawing-bed/raw/master/img/20220222194351.png)
...
<img src="https://gitee.com/router123456/drawing-bed/raw/master/img/20220222195719.png" style="zoom:80%;" />

&emsp;&emsp;如果需要静态链接，需要加上``-static``选项。

&emsp;&emsp;出现了这个报错则说明云服务器未安装C标准库的静态库：

![](https://gitee.com/router123456/drawing-bed/raw/master/img/20220227205839.png)
...
![](https://gitee.com/router123456/drawing-bed/raw/master/img/20220222200604.png)

&emsp;&emsp;查看对应的静态库：

![](https://gitee.com/router123456/drawing-bed/raw/master/img/20220222200910.png)
...
![](https://gitee.com/router123456/drawing-bed/raw/master/img/20220222225529.png)
...
<img src="https://gitee.com/router123456/drawing-bed/raw/master/img/20220222202216.png" style="zoom:80%;" />
...
![](https://gitee.com/router123456/drawing-bed/raw/master/img/20220222202447.png)

&emsp;&emsp;首先观察到可执行文件变大了，通过``readelf -S mytestdebug | grep -i debug ``可以查看二进制文件中里头有关``debug``的行：

![](https://gitee.com/router123456/drawing-bed/raw/master/img/20220222202728.png)
...
![](https://gitee.com/router123456/drawing-bed/raw/master/img/20220222230256.png)

&emsp;&emsp;``l 函数名``：显示函数名附近的代码：

![](https://gitee.com/router123456/drawing-bed/raw/master/img/20220222230651.png)

## III b 行号 加断点

&emsp;&emsp;``b 行号``在对应行号打断点，这里的b也可以写为``break``。

![](https://gitee.com/router123456/drawing-bed/raw/master/img/20220222230807.png)

&emsp;&emsp;``b 函数名``在函数入口处打断点。

![](https://gitee.com/router123456/drawing-bed/raw/master/img/20220222230900.png)

&emsp;&emsp;``info b 或info breakpoints``:查看打过的所有断点信息。

<img src="https://gitee.com/router123456/drawing-bed/raw/master/img/20220222205423.png" style="zoom:80%;" />

## IV s(逐语句调试)和n(逐过程调试)

&emsp;&emsp;``run``：执行程序，一下子就会跑到断点那里，类似VS调试中的F5;

![](https://gitee.com/router123456/drawing-bed/raw/master/img/20220222205452.png)

&emsp;&emsp;按vs的流程，接下来应该需要了解的是逐语句调试F11和逐过程调试F10.

&emsp;&emsp;逐语句调试：``s 就是 step``

![](https://gitee.com/router123456/drawing-bed/raw/master/img/20220222205702.png)
...
![](https://gitee.com/router123456/drawing-bed/raw/master/img/20220222210113.png)

&emsp;&emsp;``p 变量名``，仅显示一次变量值，``p 表达式``，可以把变量的值更改。

&emsp;&emsp;``undisplay 显示符号``：去掉常显示。

![](https://gitee.com/router123456/drawing-bed/raw/master/img/20220222210242.png)

## VI 程序调试起来后的直接运行finish continue until

&emsp;&emsp;``finish``直接运行完当前函数。

![](https://gitee.com/router123456/drawing-bed/raw/master/img/20220222210744.png)

&emsp;&emsp;``continue``直接运行到下一个断点。

![](https://gitee.com/router123456/drawing-bed/raw/master/img/20220222210618.png)

&emsp;&emsp;``until 行号``：直接运行到某一行。

![](https://gitee.com/router123456/drawing-bed/raw/master/img/20220222212352.png)
...
![](https://gitee.com/router123456/drawing-bed/raw/master/img/20220222211248.png)

&emsp;&emsp;``disable 断点编号``：不删除断点但使断点失效：

![](https://gitee.com/router123456/drawing-bed/raw/master/img/20220222211627.png)

&emsp;&emsp;``enable 断点编号``：启动断点。

<img src="https://gitee.com/router123456/drawing-bed/raw/master/img/20220222231820.png" style="zoom:80%;" />

## VIII 其他

&emsp;&emsp;``bt`` 显示堆栈:

![](https://gitee.com/router123456/drawing-bed/raw/master/img/20220222211744.png)

&emsp;&emsp;``set var 变量名=值``，设定变量值，比较少用。

![](https://gitee.com/router123456/drawing-bed/raw/master/img/20220222211934.png)

&emsp;&emsp;``print p``:打印表达式p的值，这里的表达式也可以改变变量的值。

![](https://gitee.com/router123456/drawing-bed/raw/master/img/20220222232144.png)
...
![](https://gitee.com/router123456/drawing-bed/raw/master/img/20220222214148.png)

&emsp;&emsp;然后直接执行make命令即可，也可以``make 目标名``，直接``make``默认执行第一个目标。

![](https://gitee.com/router123456/drawing-bed/raw/master/img/20220222214116.png)
...
![](https://gitee.com/router123456/drawing-bed/raw/master/img/20220222214954.png)

&emsp;&emsp;我们的普通目标，在生成后，如果检查到已经是最新的了，系统不会允许我们更新：

![](https://gitee.com/router123456/drawing-bed/raw/master/img/20220222215059.png)

&emsp;&emsp;但是``make clean``却可以一直执行。

<img src="https://gitee.com/router123456/drawing-bed/raw/master/img/20220222215222.png" style="zoom:80%;" />
...
![](https://gitee.com/router123456/drawing-bed/raw/master/img/20220222221532.png)

&emsp;&emsp;执行``make``：

![](https://gitee.com/router123456/drawing-bed/raw/master/img/20220222221953.png)

&emsp;&emsp;执行清理项目文件：

![](https://gitee.com/router123456/drawing-bed/raw/master/img/20220222222247.png)

&emsp;&emsp;一个管理堆的oj的debug版本和release版本的代码：

![](https://gitee.com/router123456/drawing-bed/raw/master/img/20220223002501.png)

## IV make的特殊符号

``$@``和``$^``:``$@``的含义是替换为本条命令的目标，``$^``的含义是默认替换成**本目标所依赖的文件列表**。

![](https://gitee.com/router123456/drawing-bed/raw/master/img/20220226143934.png)

用``$@``和``$^``显示所有编译细节：

![](https://gitee.com/router123456/drawing-bed/raw/master/img/20220226144502.png)
...
![](https://gitee.com/router123456/drawing-bed/raw/master/img/20220226145251.png)

![](https://gitee.com/router123456/drawing-bed/raw/master/img/20220226145155.png)

&emsp;&emsp;但是如果我们的字符串里头没有'\n'就会变成先等待五秒然后输出这个字符串：

![](https://gitee.com/router123456/drawing-bed/raw/master/img/20220226145508.png)

![](https://gitee.com/router123456/drawing-bed/raw/master/img/20220226145429.png)

![](https://gitee.com/router123456/drawing-bed/raw/master/img/20220226145443.png)
...
<img src="https://gitee.com/router123456/drawing-bed/raw/master/img/20220226150122.png" style="zoom:80%;" />

<img src="https://gitee.com/router123456/drawing-bed/raw/master/img/20220226150034.png" style="zoom:80%;" />
...
![](https://gitee.com/router123456/drawing-bed/raw/master/img/20220226150716.png)

![](https://gitee.com/router123456/drawing-bed/raw/master/img/20220226150633.png)

如果要对第一个位置的数不停的刷新覆盖，可以打印一个数，然后回车回到开头第一个位置而不换行，即我们不换行而只想回车，反复打印数即可，在C语言中，``\r``就是只回车不换行，据此，我们就实现了一个简易的倒计时：

<img src="https://gitee.com/router123456/drawing-bed/raw/master/img/20220226151252.png" style="zoom:80%;" />

![](https://gitee.com/router123456/drawing-bed/raw/master/img/20220226151359.png)

如果想完成10到0的倒计时，由于10会占两个字符，所以我们需要给它预留空间：

<img src="https://gitee.com/router123456/drawing-bed/raw/master/img/20220226151650.png" style="zoom:80%;" />

![](https://gitee.com/router123456/drawing-bed/raw/master/img/20220226151538.png)

![](https://gitee.com/router123456/drawing-bed/raw/master/img/20220226151600.png)

## II 进度条的实现

所以进度条也可以打印1个#，然后回车打印两个#，重复。。。如果想打印两个#，只要让h后一个字符也变成#，然后回车但不换行输出h即可

![](https://gitee.com/router123456/drawing-bed/raw/master/img/20220226152406.png)

![](https://gitee.com/router123456/drawing-bed/raw/master/img/20220226152305.png)

那如果想形成以下模样呢？

![](https://gitee.com/router123456/drawing-bed/raw/master/img/20220226152710.png)
...
<img src="https://gitee.com/router123456/drawing-bed/raw/master/img/20220226153434.png" style="zoom:80%;" />

![](https://gitee.com/router123456/drawing-bed/raw/master/img/20220226153413.png)
...
<img src="https://gitee.com/router123456/drawing-bed/raw/master/img/20220226211314.png" style="zoom:80%;" />

我们修改后的输出样式如图：

![](https://gitee.com/router123456/drawing-bed/raw/master/img/20220226213848.png)
...
<img src="https://gitee.com/router123456/drawing-bed/raw/master/img/20220226154040.png" style="zoom:80%;" />

![](https://gitee.com/router123456/drawing-bed/raw/master/img/20220226154255.png)

创建好后修改代码仓库为开源的

![](https://gitee.com/router123456/drawing-bed/raw/master/img/20220226154710.png)

![](https://gitee.com/router123456/drawing-bed/raw/master/img/20220226154722.png)

<img src="https://gitee.com/router123456/drawing-bed/raw/master/img/20220226154645.png" style="zoom:80%;" />

## III 本地git操作

克隆到本地：

![](https://gitee.com/router123456/drawing-bed/raw/master/img/20220226154600.png)

[记得要把提交邮箱改为公开](https://gitee.com/profile/emails)，或者使用在这个网址中对应的加密邮箱地址。

<img src="https://gitee.com/router123456/drawing-bed/raw/master/img/20220226160554.png" style="zoom:80%;" />
...
<img src="https://gitee.com/router123456/drawing-bed/raw/master/img/20220226161510.png" style="zoom:80%;" />

``git push``:把你的提交同步到远端服务器上，然后需要输入你的gitee账号和密码。

<img src="https://gitee.com/router123456/drawing-bed/raw/master/img/20220226161404.png" style="zoom:80%;" />

``git log``可以查看git提交的日志：

 <img src="https://gitee.com/router123456/drawing-bed/raw/master/img/20220226162221.png" style="zoom:80%;" >
